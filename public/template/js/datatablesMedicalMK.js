$(document).ready(function () {
    ...
    var dataTable = $('#dataTableMedicalMK').DataTable({
        columns: [
            { searchable: false }, // No
    ...
    dataTable.on('search.dt', function () {
        ...
        var exportUrl = currentUrl.origin + currentUrl.pathname.replace('/medical-verifikasi', '') + '/medical-export-excel' + currentUrl.search;
