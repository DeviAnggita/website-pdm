$(document).ready(function () {
    ...
    var dataTable = $('#dataTablePenunjangKantorKD').DataTable({
        columns: [
            { searchable: false }, // No
    ...
    dataTable.on('search.dt', function () {
        ...
        var exportUrl = currentUrl.origin + currentUrl.pathname.replace('/penunjang-kantor-verifikasi', '') + '/penunjang-kantor-export-excel' + currentUrl.search;
