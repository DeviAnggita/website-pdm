$(document).ready(function () {
    ...
    var dataTable = $('#dataTablePerjalananBisnisKaryawan').DataTable({
        columns: [
            { searchable: false }, // No
    ...
    dataTable.on('search.dt', function () {
        ...
        var exportUrl = currentUrl.origin + currentUrl.pathname.replace('/perjalanan-bisnis', '') + '/perjalanan-bisnis-export-excel' + currentUrl.search;
