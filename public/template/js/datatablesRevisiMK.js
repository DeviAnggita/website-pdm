$(document).ready(function() {
    ...
    var dataTable = $('#dataTableRevisiMK').DataTable({
        columns: [
            { searchable: false }, // No
    ...
    dataTable.on('search.dt', function() {
        ...
        var exportUrl = currentUrl.origin + currentUrl.pathname.replace('/revisi-verifikasi', '') + '/revisi-verifikasi-export-excel' + currentUrl.search;
