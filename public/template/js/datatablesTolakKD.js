$(document).ready(function () {
    ...
    var dataTable = $('#dataTableTolakKD').DataTable({
        columns: [
            { searchable: false }, // No
    ...
    dataTable.on('search.dt', function () {
        ...
        var exportUrl = currentUrl.origin + currentUrl.pathname.replace('/tolak-verifikasi', '') + '/tolak-verifikasi-export-excel' + currentUrl.search;
