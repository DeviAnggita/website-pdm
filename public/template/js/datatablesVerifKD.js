$(document).ready(function () {
    ...
    var dataTable = $('#dataTableVerifikasiKD').DataTable({
        columns: [
            { searchable: false }, // No
    ...
    dataTable.on('search.dt', function () {
        ...
        var exportUrl = currentUrl.origin + currentUrl.pathname.replace('/verifikasi', '') + '/verifikasi-export-excel' + currentUrl.search;
