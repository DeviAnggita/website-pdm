                        ...
                        <div class="col-md-3">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('user.profile.updateFotoProfile', $user->ID_USER) }}"
                        ...
                        <div class="col-md-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST"
                                        action="{{ route('user.profile.updateKelolaPengguna', $user->ID_USER) }}"
                        ...
                        <div class="col-md-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('user.profile.updateKelolaAkun', $user->ID_USER) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
